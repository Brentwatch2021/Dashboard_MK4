...
namespace Dashboard_MK4.Migrations.JobCard_TaskDescriptions_
{
    ...
    [Migration("20200408111510_Dashboard_MK4.Models.V3_Models.JobCard_TaskDescriptions_Context")]
    partial class Dashboard_MK4ModelsV3_ModelsJobCard_TaskDescriptions_Context
    {
            ...
            modelBuilder.Entity("Dashboard_MK4.Models.V3_Models.TaskDescriptionV3", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Task_Description_ID = new Guid("00000000-0000-0000-0000-000000000015"),
                            Description = "Remove and fit clutch",
                            JobCardID = new Guid("00000000-0000-0000-0000-000000000012"),
                            LabourCost = "1500",
                            PartsPrice = "2000",
                            TotalTaskCost = "3500"
