...
namespace Dashboard_MK4
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<JobCard_TaskDescriptions_Context>(opts => opts.UseSqlServer(Configuration["ConnectionString:EmployeeDBMk4"]));
            services.AddDbContext<JTFA_Task_Description_Context>(opts => opts.UseSqlServer(Configuration["ConnectionString:EmployeeDBMk4"]));
            ...
            services.AddDbContext<JTFA_Client_Context>(opts => opts.UseSqlServer(Configuration["ConnectionString:EmployeeDBMk4"]));
            services.AddScoped<IJTFA_Client_Data_Repository<JTFA_Client>, JTFA_Client_Manager>();
            services.AddDbContext<Vehicle_Context>(opts => opts.UseSqlServer(Configuration["ConnectionString:EmployeeDBMk4"]));
            ...
            services.AddDbContext<Job_Card_Context>(opts => opts.UseSqlServer(Configuration["ConnectionString:EmployeeDBMk4"]));
            services.AddDbContext<EmployeeContext>(opts => opts.UseSqlServer(Configuration["ConnectionString:EmployeeDBMk4"]));
